...
-(NSString*)formatOdometerA6WithString:(NSString*)formatString
{
...
@implementation LTOBD2PID_VEHICLE_ODOMETER_A6

-(NSString*)formattedResponse
{
    NSString* string = [self formatOdometerA6WithString:@"%.1f"];
    return string;
}
