...
{
    GKAchievementNotification  *_achievement;  /**< Description of achievement earned. */
...
@property (nonatomic, retain) GKAchievementNotification *achievement;
 ...
 */
- (id)initWithAchievementDescription:(GKAchievementNoficiation *)achievement;
