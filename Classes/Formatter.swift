...
public extension Date {
    ...
    init?(fromString string: String, format: DateFormatType, timeZone: TimeZoneType = .local, locale: Locale = Foundation.Locale.current, isLenient: Bool = true) {
        ...
        case .isoDateTimeFull, .isoDateTime, .isoYear, . isoDate, .isoYearMonth:
            ...
            return nil
        case .usDate, .usDateTime12WithSec, .usDateTime12NoSec, .usDateTime24WithSec, .usDateTime24NoSec:
    ...
    enum DateFormatType {
        /// The us formatted date "MM/dd/yyyy" i.e. 11/01/2002
        case usDate
        /// The us formatted date time 12H "MM/dd/yyyy h:mm:ss a " i.e. 11/01/2002 10:30:00 AM
        case usDateTime12WithSec
        /// The us formatted date time 12H "MM/dd/yyyy h:mm a " i.e. 11/01/2002 10:30 AM
        case usDateTime12NoSec
        /// The us formatted date time 12H "MM/dd/yyyy H:mm:ss " i.e. 11/01/2002 13:30:00
        case usDateTime24WithSec
        /// The us formatted date time 12H "MM/dd/yyyy H:mm " i.e. 11/01/2002 13:30
        case usDateTime24NoSec
