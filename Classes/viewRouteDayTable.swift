//
//  viewRouteDayTable.swift
//  BulwarkTW
//
//  Created by Terry Whipple on 3/28/22.
//

import UIKit

class viewRouteDayTable: UITableViewController {
    ...
    class RouteStopCell: UITableViewCell{
        ...
        @IBOutlet var lblEstArrival: UILabel!
        @IBOutlet var lblName: UILabel!
        @IBOutlet var lblAddress: UILabel!
        @IBOutlet var lblImportaint: UILabel!
